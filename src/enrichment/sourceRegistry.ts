...
const registry = {
  ...
  "grid3-nigeria-settlements": {
    ...
    documentationUri: "https://grid3.org/",
    licenseId: "PRODUCT-SPECIFIC-REVIEW-REQUIRED",
    attributionText: "GRID3 / source partners; use exact settlement-release attribution from reviewed metadata",
    shareAlike: true,
    ...
    notes: "Generic settlement ingestion is disabled. Use the dedicated v4.1 importer, which requires exact release-specific license/commercial review and declared source coverage evidence.",
  },
  "grid3-nigeria-roads": {
